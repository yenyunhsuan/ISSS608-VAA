...
1.  [,-3]: select all data except for column 3

2.  guides(fill=FALSE) means to turn off legend

3. create new histogram, one use sub_data without gender column, one use data and with black line and fill different color by gender.
